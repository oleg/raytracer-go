...
func MakeSphereTM(transform multid.Matrix, material Material) Sphere {
	return Sphere{transform, material}
}

func MakeSphereT(transform multid.Matrix) Sphere {
...
func (sphere Sphere) Transform() multid.Matrix {
